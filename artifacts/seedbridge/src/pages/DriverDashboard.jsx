          ...
          <div className="lg:col-span-2">
            <Card>
              ...
              <CardContent className="p-0">
                {dashboard.recentDeliveries && dashboard.recentDeliveries.length > 0 ? <div className="divide-y">
                    {dashboard.recentDeliveries.map((delivery) => <Link key={delivery.id} href={`/logistics/${delivery.id}`}>
                        <div className="p-4 hover:bg-muted/50 transition-colors group">
                          <div className="flex items-center justify-between mb-2">
                            <Badge variant={delivery.status === "pending" ? "secondary" : delivery.status === "in_transit" ? "default" : delivery.status === "completed" ? "outline" : "default"} className="uppercase">
