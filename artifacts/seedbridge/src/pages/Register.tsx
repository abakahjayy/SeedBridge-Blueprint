...
export function RegisterPage() {
  ...
  const initialRole = searchParams.get('role') as RegisterInputRole || 'farmer';
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-4 py-12 bg-muted/30">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-3 gap-2">
                {(['farmer', 'buyer', 'driver'] as const).map((role) => (
                  <Button
                    key={role}
                    type="button"
