...
import { MapPin, Clock, Sprout, Star, ShieldCheck, ArrowLeft, Timer } from 'lucide-react';
...
export function ProduceDetail() {
  ...
  // Setup defaults once produce loads
  React.useEffect(() => {
          ...
          <div className="space-y-6">
            <div className="relative rounded-3xl overflow-hidden aspect-[4/3] md:aspect-auto md:h-[500px] border shadow-sm">
              <img 
                ...
                onError={(e) => {
                  (e.target as HTMLImageElement).src = 'https://images.unsplash.com/photo-1596199050105-6d5d32222916?auto=format&fit=crop&q=80&w=1200';
                }}
              />
              {isRescue && (
          ...
          <div className="flex flex-col">
            <div className="mb-6">
              <div className="flex items-center gap-2 mb-2 text-muted-foreground">
                <span className="text-2xl">{CROP_EMOJIS[produce.crop] || "📦"}</span>
              ...
              <div className="flex items-baseline gap-3 mb-6">
                ...
                {isRescue && produce.originalPricePerKg && (
                  <span className="ml-2 text-lg text-destructive line-through decoration-destructive/50">
              ...
              <CardContent className="p-6 space-y-6">
                ...
                <div className="border-t pt-4 flex items-end justify-between">
                  <div>
                    ...
                    {isPreHarvest && produce.depositRequired && (
